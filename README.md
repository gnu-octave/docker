...
- [Docker](https://www.docker.com/):
  ...
  docker run -it --rm gnuoctave/octave:10.3.0 octave
  ```
...
- [Singularity](https://sylabs.io/singularity/):
  ...
  singularity run octave_10.3.0.sif
  ```
...
docker run \
  ...
  --workdir="$HOME" \
  docker.io/gnuoctave/octave:10.3.0 octave --gui
```
...
```
singularity exec --bind /run/user octave_10.3.0.sif octave --gui
```
